...
void determineTriangleVertex(vector<Point2f>& pointSet, Car& car)
{
	...
	//cout << "edgeNode" << endl;
	//cout << edgeNode.V1 << endl;
	//cout << edgeNode.V2 << endl;
	//circle(cimage, edgeNode.V1, 3, Scalar(255, 0, 0), 
	//		FILLED, LINE_AA);
	//circle(cimage, edgeNode.V2, 3, Scalar(255, 0, 0), 
	//		FILLED, LINE_AA);
	...
	EdgeNode edgeNodeAnother = findMaxDistance(pointSet, 
			maxDistance);
	//cout << "edgeNodeAnother" << endl;
	//cout << edgeNodeAnother.V1 << endl;
	//cout << edgeNodeAnother.V2 << endl;
	// circle(cimage, edgeNodeAnother.V1, 3, Scalar(255, 0, 0), 
	// 		FILLED, LINE_AA);
	// circle(cimage, edgeNodeAnother.V2, 3, Scalar(255, 0, 0), 
	// 		FILLED, LINE_AA);
	//cout << edgeNodeAnother.Weight << endl;
	// exception 
	//if ((maxDistance - edgeNodeAnother.Weight) < 0.02)
	//{
...
//	cout << car.first << endl;
	...
	circle(cimage, vertex, 5, Scalar(255, 255, 255), 
			FILLED, LINE_AA);
  ...
  //  cout << center << endl;
   // cout << centerInt << endl;
    ...
    //circle(cimage, center, 3, Scalar(0, 0, 255), 
	//		FILLED, LINE_AA);
